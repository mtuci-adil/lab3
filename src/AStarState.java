...
public class AStarState {
    ...
    public Waypoint getMinOpenWaypoint() {
        return Collections.min(openWaypoints.values(), Comparator.comparing(Waypoint::getTotalCost));
    }
    ...
    public void addOpenWaypoint(Waypoint newWP) {
        if (openWaypoints.putIfAbsent(newWP.loc, newWP) != null) openWaypoints.computeIfPresent(newWP.loc, (k, v) ->
                newWP.getPreviousCost() < v.getPreviousCost() ? newWP : v);
    }
